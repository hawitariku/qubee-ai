"""
Download additional Afaan Oromo Wikipedia articles to expand corpus further.

This script adds more diverse topics to reach 1000+ words.
"""
...
def main():
    print("=" * 60)
    print("🌐 Additional Wikipedia Articles Downloader")
    print("=" * 60)
    print()
    print("Downloading more diverse topics...")
    print()
    
    # More articles covering different topics
    articles = [
        # Geography & Places
        "Biyya",
        "Magaalaa",
